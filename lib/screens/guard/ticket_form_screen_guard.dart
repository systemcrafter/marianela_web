...
class TicketFormScreenGuard extends StatefulWidget {
  const TicketFormScreenGuard({super.key});

  @override
  State<TicketFormScreenGuard> createState() => _TicketFormScreenState();
}

class _TicketFormScreenState extends State<TicketFormScreenGuard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Abrir Tiquete (Oficiales de Seguridad)"),
